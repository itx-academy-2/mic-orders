...
/**
 * Use case for generating a secondary password reset token from a primary token. The secondary token is used in the final step of the
 * password reset process.
 */
public interface GenerateSecondaryTokenUseCase {
  /**
   * Generates a secondary token based on the provided primary token. The primary token is marked as used during this process.
   *
