...
/**
 * Port interface for password hashing operations. Implementations should use cryptographically secure hashing algorithms with proper salt
...
public interface PasswordHashingPort {
   ...
   * (bcrypt) - Generate a unique salt for each password - Use appropriate work factors to resist brute force attacks
   *
