...
public interface ResetPasswordUseCase {
  ...
  /**
   * Resets the user's password using the provided command. <p> This method validates the token included in the command, hashes the new
   * password, stores it securely, and marks the token as used.
   *
