...
public interface OrderRepository {
   ...
   *
   * @param id with type {@link UUID}
   * @param language language of fetched products in order items
   * @return {@link Optional} of {@link Order}
   */
   ...
   * @param language the language in which the orders should be retrieved.
   ...
   *
   * @param filterParametersDto filter parameters to sort orders.
   * @param pageable the pagination and sorting information.
   * @return a Page of OrderEntity objects matching the specified criteria.
   * @author Denys Liubchenko
   */
   ...
   * @return an {@link Optional} containing the {@link Order} with related data if found, or empty if not found.
   * @author Denys Liubchenko
   */
