...
public interface UpdateProductUseCase {
  /**
   * Updates the details of an existing product based on the provided product ID and update information.
   *
   * @param productId the UUID of the product to be updated.
   * @param updateProduct the {@link ProductRequestDto} containing updated information for the product.
