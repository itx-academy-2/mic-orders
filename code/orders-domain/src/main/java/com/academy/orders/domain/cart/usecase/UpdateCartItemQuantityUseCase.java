...
public interface UpdateCartItemQuantityUseCase {
   ...
   *
   * @param productId the UUID of the product whose quantity is to be updated in the cart.
   ...
   * @return an {@link UpdatedCartItemDto} containing the updated cart item details.
