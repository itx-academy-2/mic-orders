...
public interface GetAllUsersUseCase {
   ...
   *
   * @param filter the {@link AccountManagementFilterDto} containing filtering criteria such as role, status, etc.
   * @param pageable the {@link Pageable} object for pagination and sorting information.
   * @return a {@link Page} of {@link Account} objects that match the filter criteria.
