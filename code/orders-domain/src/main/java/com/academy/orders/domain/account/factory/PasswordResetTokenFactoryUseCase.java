...
/**
 * Factory interface for creating instances of {@link PasswordResetToken}.
 * <p>
 * This abstraction allows for centralized construction of password reset tokens,
 * ensuring proper initialization (e.g., setting token value, expiration, and status).
 */
