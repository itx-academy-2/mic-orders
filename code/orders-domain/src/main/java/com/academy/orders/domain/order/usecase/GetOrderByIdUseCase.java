...
public interface GetOrderByIdUseCase {
  /**
   * Retrieves an order by its ID with details localized to the specified language.
   *
   * @param id the UUID of the order to be retrieved.
   * @param language the language code for localization of the order details.
