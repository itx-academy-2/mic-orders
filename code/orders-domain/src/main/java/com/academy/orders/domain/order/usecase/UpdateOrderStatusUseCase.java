...
public interface UpdateOrderStatusUseCase {
   ...
   * @param updateOrderStatus the DTO containing the new status and payment information to be set for the order.
   * @param role the role of the current user performing the update.
   * @return an {@link OrderStatusInfo} object containing a list of available statuses that the order can transition to from its new state
   *         and the payment status of the order.
   * @author Anton Bondar
   */
