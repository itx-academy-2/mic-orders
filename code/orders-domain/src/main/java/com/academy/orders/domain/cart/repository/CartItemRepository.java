...
public interface CartItemRepository {
   ...
   *
   * @param productId with type {@link UUID}
   * @param accountId with type {@link Long}
   * @return {@link Boolean}
   ...
   *
   * @param cartItem with type {@link CreateCartItemDTO}
   ...
   *
   * @param accountId id of the logged-in user.
   * @author Denys Ryhal
   */
   ...
   *
   * @param accountId id of the logged-in user.
   * @param lang translation of the product.
   * @author Denys Ryhal
   */
