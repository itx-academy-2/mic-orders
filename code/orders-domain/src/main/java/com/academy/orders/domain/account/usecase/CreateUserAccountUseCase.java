...
public interface CreateUserAccountUseCase {
   ...
   *
   * @param account the {@link CreateAccountDTO} object containing information about the new account.
   * @throws AccountAlreadyExistsException if the provided account's email already exists.
   * @author Denys Ryhal
   */
