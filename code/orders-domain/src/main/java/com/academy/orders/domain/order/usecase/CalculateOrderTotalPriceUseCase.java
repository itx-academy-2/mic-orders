...
public interface CalculateOrderTotalPriceUseCase {
   ...
   *
   * @param orderItems the list of order items for which to calculate the total price
   ...
   *
   * @param orders the list of orders for which to calculate the total price
  ...
  /**
   * Calculates the total price for each order in a list of orders and determines the available statuses based on the user's role.
   *
   * @param orders the list of orders for which to calculate the total price
   * @param role the role of the current user.
   * @return the list of orders with their total prices calculated and available statuses to change
   * @author Denys Liubchenko
   */
