...
/**
 * Repository interface for managing and loading images for products in a shopping cart.
 */
public interface CartItemImageRepository {
   ...
   *
   * @param cartItem the {@link CartItem} for which the product image needs to be loaded.
