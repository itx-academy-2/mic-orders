...
public interface OrderJpaAdapter extends CrudRepository<OrderEntity, UUID> {
  /**
   * Retrieves a paginated list of OrderEntity objects for a specific account, including related entities such as post addresses, order
   * items, and product ids.
   *
   * @param accountId the ID of the account for which orders are to be retrieved.
  ...
  /**
   * Retrieves a list of orders by their IDs, fetching associated product data. The method uses a complex query to eagerly fetch related
   * entities such as account, post address, order items, products, product translations, languages, and tags.
   *
   * @param orderIds the list of order IDs to retrieve
   * @param language the language code to filter product translations
  ...
  /**
   * Retrieves an OrderEntity by his id, including related entities such as post addresses, order items, and product ids.
   *
   * @param id the ID of the account for which orders are to be retrieved.
  ...
  /**
   * Retrieves an OrderEntity by his id, including related entities such as post addresses and product ids.
   *
   * @param id the ID of the account for which orders are to be retrieved.
   * @return {@link Optional} containing the {@link OrderEntity} if it is present.
   * @author Denys Liubchenko
   ...
   *
   * @param orderId the unique identifier of the order to be updated.
   * @param isPaid a boolean indicating whether the order is paid or not. `true` if the order is paid, `false` otherwise.
   * @author Anton Bondar
   */
  @Modifying
