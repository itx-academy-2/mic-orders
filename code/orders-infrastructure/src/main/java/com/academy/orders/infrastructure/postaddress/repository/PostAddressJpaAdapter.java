...
public interface PostAddressJpaAdapter extends CrudRepository<PostAddressV2Entity, UUID> {
   ...
   * @return {@code true} if a post address with the given ID exists and its title starts with the specified prefix, {@code false} otherwise
   * @author Oleksandra Bulhakova
   */
  boolean existsByIdAndTitleStartingWith(UUID addressId, String prefix);

  /**
   * Updates the title of the post address with the specified ID to mark it as temporary. The new title is generated by concatenating the
