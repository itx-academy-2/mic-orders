...
public interface PostAddressJpaAdapter extends CrudRepository<PostAddressV2Entity, UUID> {
    /**
     * Retrieves a post address V2 entity by its title and associated account ID.
     * This method is used to ensure that each account has unique permanent post address titles.
     *
