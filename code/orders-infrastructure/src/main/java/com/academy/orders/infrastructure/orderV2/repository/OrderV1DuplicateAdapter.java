...
/**
 * Adapter class responsible for duplicating newly created OrderV2 data into the legacy OrderV1 table structure.
 * It directly uses native SQL via {@link jakarta.persistence.EntityManager} to preserve the UUIDs
 * and prevent Hibernate's {@code @GeneratedValue} strategy from overriding them.
 * This duplication supports a temporary coexistence phase between the new V2 architecture and the old V1 schema.
 * It will be safely removed once the migration to V2 is fully completed.
 *
